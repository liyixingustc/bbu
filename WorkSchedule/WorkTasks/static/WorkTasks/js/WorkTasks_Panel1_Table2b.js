...
define(function (require) {
    ...
    function run() {
        var $table_container_id = $("#"+WorkTasks_Panel1_Table2b_container_id),
            $table_id = $("#"+WorkTasks_Panel1_Table2b_id);
    ...
    function event($table_id) {
        ...
        $table_id.on('editable-save.bs.table',function (editable, field, row, oldValue, $el) {
            ...
            $.post(WorkTasks_Panel1_Table2b_url_edit,{'name':row['name'],'duration':row[field],'date':field},function () {
        ...
        //check events
        // $table_id.on('check.bs.table',function (row, $el) {
        //     console.log(row)
        //     console.log($el)
        // })
    }
